        ...
        <tbody>
            ...
            foreach ($entreprise as $item) { ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?view=edit&id=<?= $entreprise['id'] ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                        <a href="index.php?view=delete&id=<?= $entreprise['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                    </td>
                <?php } ?>
