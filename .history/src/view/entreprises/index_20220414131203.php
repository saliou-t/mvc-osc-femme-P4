        ...
        <tbody>
            ...
            foreach ($entreprise as $item) { ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?view=modification&id=<?= $entre['id'] ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                        <a href="index.php?view=supprimer&id=<?= $entre['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                    </td>
                <?php } ?>
